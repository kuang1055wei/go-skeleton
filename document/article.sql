...
INSERT INTO `category` VALUES (5, '测试');
...
INSERT INTO `comment` VALUES (13, '2021-03-19 16:21:47.813', '2021-03-19 16:39:36.998', NULL, 1, 1, '123123123123', 1, NULL, 'admin', '');
...
CREATE TABLE `products`  (
  ...
  `updated_at` datetime(3) NULL DEFAULT NULL,
  `deleted_at` datetime(3) NULL DEFAULT NULL,
  `code` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL,
...
-- Records of products
-- ----------------------------
INSERT INTO `products` VALUES (1, '2021-04-06 16:05:50.151', '2021-04-06 16:05:50.169', '2021-04-06 16:05:50.171', 'F42', 200);
...
-- Records of profile
-- ----------------------------
INSERT INTO `profile` VALUES (1, 'weject', '请输入个人介绍', 'QQ号码', '微信号码', '微博地址', 'B站地址', '电子邮箱', 'http://test.scjglaw.cn/FsdR3jZStpoxJ1652sFmNMtwqiFY', 'http://test.scjglaw.cn/Fm63wdxiVmW7xN3z2R-czYUdMmLY', NULL);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '2021-02-09 17:05:14.764', '2021-03-19 17:57:15.453', NULL, 'admin', '$2a$10$YGL5a9z7ykG6BWOo.XhJU.h8r98BD5IvAmLISBB9rFIefbDzrv58O', 1);
